...
def demo_one_sample(model, model_name, device, sample, cano_sz, image, args: argparse.Namespace):
    #######################################################################
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample-file", type=str, default='demo/input/video.json')
