...
def main(config: Dict[str, Any], args: argparse.Namespace):
    ...
    # sample = valid_dataset[0]  # 检查第一个样本
    # print("11111111111111111111111111111111111111111111111",sample.keys())  # 查看实际存在的键

    valid_sampler = SequentialSampler(valid_dataset)
    valid_loader = DataLoader(
        valid_dataset,
        batch_size=args.val_batch_sz or 1,
        num_workers=4,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config-file", type=str, default="configs/test/dac_swinl_indoor_test_diode.json")
    ...
    parser.add_argument("--base-path", default="datasets")
