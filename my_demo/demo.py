...
def demo_one_sample(model, model_name, device, sample, cano_sz, args: argparse.Namespace, x, y):
    #######################################################################
    ...
    cv2.putText(display_img, text_pred, (x+5, y-8), font, 0.5, (255, 255, 255), 1)
...
if __name__ == "__main__":
    ...
    demo_one_sample(model, config["model_name"], device, sample, cano_sz, args, 50, 50)
    print("Demo finished")
