    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        if 0 <= x_original < pred_depth_map.shape[1] and 0 <= y_original < pred_depth_map.shape[0]:
            ...
            param['click_history'].append({
                    'position': (x_original, y_original),
...
def demo_one_sample(model, model_name, device, sample, cano_sz, args: argparse.Namespace):
    ...
    while True:
        ...
        for click in callback_params['click_history']:
            ...
            cv2.putText(display_img, text_pred, (x+10, y-10), font, 0.6, (255, 255, 255), 2)
            cv2.putText(display_img, text_gt, (x+10, y+10), font, 0.6, (255, 255, 255), 2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sample-file", type=str, default='data/diobe_test.json')
